            ...
            <form class="" action="<?= base_url().'admin/User/edit/'.$user[0]->id_user ?>" method="post">
              <div class="panel-body">
                <div class="form-group <?= empty(form_error('name'))  ? '' : 'has-error' ?>">
                  ...
                  <input type="text" name="name" id="name" class="form-control" placeholder="Name" value="<?= set_value('name', $user[0]->name) ?>">
                ...
                <div class="form-group <?= empty(form_error('address'))  ? '' : 'has-error' ?>">
                  ...
                  <textarea name="address" rows="2" id="address" placeholder="Address" class="form-control"><?= set_value('address', $user[0]->address) ?></textarea>
                ...
                <div class="form-group <?= empty(form_error('id_level'))  ? '' : 'has-error' ?>">
                  ...
                  <div class="form-group <?= empty(form_error('phone'))  ? '' : 'has-error' ?>">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone" value="<?= set_value('phone', $user[0]->phone) ?>">
